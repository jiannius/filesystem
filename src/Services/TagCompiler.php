...
/**
 * Make custom tag <filesystem:component/>
 * Thanks to livewire/flux for the inspiration
 */
class TagCompiler extends ComponentTagCompiler
{
    ...
    protected function compileOpeningTags(string $value)
    {
        ...
        return preg_replace_callback($pattern, function (array $matches) {
            ...
            return $this->componentString('filesystem::'.$matches[1], $attributes);
        }, $value);
    }
    ...
    protected function compileSelfClosingTags(string $value)
    {
        ...
        return preg_replace_callback($pattern, function (array $matches) {
            ...
            if (isset($attributes['slot'])) {
                ...
                return '@slot('.$slot.') ' . $this->componentString('filesystem::'.$matches[1], $attributes)."\n@endComponentClass##END-COMPONENT-CLASS##" . ' @endslot';
            }
    ...
    {
        return preg_replace("/<\/\s*filesystem[\:][\w\-\:\.]*\s*>/", ' @endComponentClass##END-COMPONENT-CLASS##', $value);
    }
}